...
export { __exports as default } from '../../../../_virtual/entrypoints.js';
 ...
 */
entrypoints.processExportsField = function processExportsField(
	exportsField
) {
 ...
 * @returns {FieldProcessor} process callback
 */
entrypoints.processImportsField = function processImportsField(
	importsField
) {
	return createFieldProcessor(
