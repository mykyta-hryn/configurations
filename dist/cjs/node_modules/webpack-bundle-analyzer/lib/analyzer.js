...
require('../../gzip-size/index.js');
var Logger$1 = require('./Logger.js');
require('./tree/Folder.js');
var parseUtils = require('./parseUtils.js');
require('./utils.js');
var Folder$1 = require('../../../_virtual/Folder.js');
...
const gzipSize = index.gzipSize.exports;

const Logger = Logger$1;

const Folder = Folder$1.__exports.default;
