...
var entrypoints = require('../../../../_virtual/entrypoints.js');
 ...
 */
entrypoints.__exports.processExportsField = function processExportsField(
	exportsField
) {
 ...
 * @returns {FieldProcessor} process callback
 */
entrypoints.__exports.processImportsField = function processImportsField(
	importsField
) {
	return createFieldProcessor(
...
module.exports = entrypoints.__exports;
