...
require('../../tapable/lib/index.js');
var createInnerContext$1 = require('./createInnerContext.js');
require('./util/identifier.js');
require('./util/path.js');
var index = require('../../../_virtual/index.js');
var identifier = require('../../../_virtual/identifier.js');
...
const { AsyncSeriesBailHook, AsyncSeriesHook, SyncHook } = index.__exports;
const createInnerContext = createInnerContext$1;
const { parseIdentifier } = identifier.__exports;
const {
	normalize,
	cachedJoin: join,
	getType,
